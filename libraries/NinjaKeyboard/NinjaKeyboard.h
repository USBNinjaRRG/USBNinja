 ...
 */
#ifndef __NinjaKeyboard_h__
#define __NinjaKeyboard_h__
...
#include "include/scancode-ascii-table.h"
...
class NinjaKeyboardDevice : public Print {
 public:
  NinjaKeyboardDevice () {
    cli();
    usbDeviceDisconnect();
...
NinjaKeyboardDevice NinjaKeyboard = NinjaKeyboardDevice();
...
extern "C"{
  ...
  // USB_PUBLIC uchar usbFunctionSetup
    ...
    usbMsgPtr = NinjaKeyboard.reportBuffer; //
